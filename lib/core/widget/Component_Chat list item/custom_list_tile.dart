...
class BaseChatCard extends StatelessWidget {
  ...
  final bool isOnline;
  final Widget? trailing; // هذا هو الجزء السحري للتغيير
  final Widget? bottomContent; // للجزء الخاص بالمنتج (مثل Dell XPS)
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                // الصورة مع مؤشر الحالة (موجودة في كل الكومبوننت)
                _buildAvatar(),
                ...
                // هنا نضع الشيء المتغير (زر، وقت، رقم)
